...
views.get("email").vw.setTop((int)((32d / 100 * height) - (views.get("email").vw.getHeight())));
...
views.get("password").vw.setTop((int)((45d / 100 * height) - (views.get("password").vw.getHeight())));
...
//BA.debugLineNum = 27;BA.debugLine="RegisterButton.Bottom = 75%Y"[SignUp/General script]
views.get("registerbutton").vw.setTop((int)((75d / 100 * height) - (views.get("registerbutton").vw.getHeight())));
