...
try {
		Debug.PushSubsStack("Base_Resize (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("Draw_Arc1 (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,105);
...
try {
		Debug.PushSubsStack("Draw_Arc2 (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("Draw_FiveLines1 (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,95);
...
try {
		Debug.PushSubsStack("Draw_PacMan (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,131);
...
try {
		Debug.PushSubsStack("Draw_SingleCircle (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles1 (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles2 (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("Hide (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,61);
...
try {
		Debug.PushSubsStack("Initialize (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("MainLoop (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,42);
...
try {
		Debug.PushSubsStack("SetAlpha (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("Show (b4xloadingindicator) ","b4xloadingindicator",14,__ref.getField(false, "ba"),__ref,56);
