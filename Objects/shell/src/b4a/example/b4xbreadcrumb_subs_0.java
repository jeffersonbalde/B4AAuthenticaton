...
try {
		Debug.PushSubsStack("Base_Resize (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,51);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("Draw (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("DrawItem (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,85);
...
try {
		Debug.PushSubsStack("FindItem (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,136);
...
try {
		Debug.PushSubsStack("getItems (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,153);
...
try {
		Debug.PushSubsStack("Initialize (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("setItems (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("Touch_Touch (b4xbreadcrumb) ","b4xbreadcrumb",5,__ref.getField(false, "ba"),__ref,114);
