...
try {
		Debug.PushSubsStack("CustomListView1_ItemClick (b4xlisttemplate) ","b4xlisttemplate",13,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xlisttemplate) ","b4xlisttemplate",13,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("GetPanel (b4xlisttemplate) ","b4xlisttemplate",13,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("Initialize (b4xlisttemplate) ","b4xlisttemplate",13,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Resize (b4xlisttemplate) ","b4xlisttemplate",13,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("SelectItem (b4xlisttemplate) ","b4xlisttemplate",13,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("Show (b4xlisttemplate) ","b4xlisttemplate",13,__ref.getField(false, "ba"),__ref,41);
