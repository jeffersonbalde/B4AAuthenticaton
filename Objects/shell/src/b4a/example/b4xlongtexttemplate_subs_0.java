...
try {
		Debug.PushSubsStack("DialogClosed (b4xlongtexttemplate) ","b4xlongtexttemplate",15,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("GetPanel (b4xlongtexttemplate) ","b4xlongtexttemplate",15,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("Initialize (b4xlongtexttemplate) ","b4xlongtexttemplate",15,__ref.getField(false, "ba"),__ref,8);
...
try {
		Debug.PushSubsStack("Resize (b4xlongtexttemplate) ","b4xlongtexttemplate",15,__ref.getField(false, "ba"),__ref,23);
...
try {
		Debug.PushSubsStack("Show (b4xlongtexttemplate) ","b4xlongtexttemplate",15,__ref.getField(false, "ba"),__ref,34);
