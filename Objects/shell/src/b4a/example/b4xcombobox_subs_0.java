...
try {
		Debug.PushSubsStack("Base_Resize (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("CmbBox_ItemClick (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,157);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("GetItem (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("getSelectedIndex (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("getSelectedItem (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("getSize (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("IndexOf (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,87);
...
try {
		Debug.PushSubsStack("Initialize (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("RaiseEvent (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("SetItems (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("setSelectedIndex (b4xcombobox) ","b4xcombobox",7,__ref.getField(false, "ba"),__ref,106);
