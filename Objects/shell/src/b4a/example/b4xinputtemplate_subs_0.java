...
try {
		Debug.PushSubsStack("ConfigureForNumbers (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("GetPanel (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,116);
...
try {
		Debug.PushSubsStack("Initialize (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("IsValid (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("SetBorder (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,99);
...
try {
		Debug.PushSubsStack("SetBorderColor (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,34);
...
try {
		Debug.PushSubsStack("Show (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,120);
...
try {
		Debug.PushSubsStack("TextField1_Action (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("TextField1_EnterPressed (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("TextField1_TextChanged (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("Validate (b4xinputtemplate) ","b4xinputtemplate",12,__ref.getField(false, "ba"),__ref,86);
