...
try {
		Debug.PushSubsStack("Base_Resize (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("Clear (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,25);
...
try {
		Debug.PushSubsStack("getBitmap (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("getCornersRadius (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("getResizeMode (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,67);
...
try {
		Debug.PushSubsStack("getRoundedImage (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("Initialize (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,19);
...
try {
		Debug.PushSubsStack("Load (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,110);
...
try {
		Debug.PushSubsStack("setBitmap (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,124);
...
try {
		Debug.PushSubsStack("setCornersRadius (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("setResizeMode (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,71);
...
try {
		Debug.PushSubsStack("setRoundedImage (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("Update (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,77);
...
Debug.JustUpdateDeviceLine();
b4ximageview.__c.runVoidMethod ("LogImpl","911010075",RemoteObject.concat(RemoteObject.createImmutable("Invalid resize mode: "),__ref.getField(true,"_mresizemode" /*RemoteObject*/ )),0);
 break; }
}
;
...
try {
		Debug.PushSubsStack("UpdateClip (b4ximageview) ","b4ximageview",11,__ref.getField(false, "ba"),__ref,135);
