...
try {
		Debug.PushSubsStack("Base_Resize (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,70);
...
try {
		Debug.PushSubsStack("CreateBitmap (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("CreateFadeBitmap (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("DesignerCreateView (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("getValue (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,120);
...
try {
		Debug.PushSubsStack("Initialize (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("setValue (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("TopFromValue (animatedcounter) ","animatedcounter",3,__ref.getField(false, "ba"),__ref,88);
