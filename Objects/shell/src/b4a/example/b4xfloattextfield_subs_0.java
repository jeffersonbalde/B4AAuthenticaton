...
try {
		Debug.PushSubsStack("Base_Resize (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,196);
...
try {
		Debug.PushSubsStack("CreateAcceptButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("CreateBitmap (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,257);
...
try {
		Debug.PushSubsStack("CreateButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("CreateClearButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("CreateRevealButton (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,132);
...
try {
		Debug.PushSubsStack("CreateTextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,328);
...
try {
		Debug.PushSubsStack("CreateTextFieldAll (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,67);
...
Debug.JustUpdateDeviceLine();
b4xfloattextfield.__c.runVoidMethod ("LogImpl","98650776",RemoteObject.createImmutable("Multiline not supported with password mode."),0);
 };
...
try {
		Debug.PushSubsStack("getNextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,295);
...
try {
		Debug.PushSubsStack("getText (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,388);
...
try {
		Debug.PushSubsStack("getTextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,445);
...
try {
		Debug.PushSubsStack("ime_HandleAction (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,314);
...
try {
		Debug.PushSubsStack("Initialize (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("lc_Click (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,403);
...
try {
		Debug.PushSubsStack("RequestFocusAndShowKeyboard (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,450);
...
try {
		Debug.PushSubsStack("setNextField (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,299);
...
try {
		Debug.PushSubsStack("setText (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,392);
...
try {
		Debug.PushSubsStack("SwitchFromPasswordToRegular (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("tf_Action (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,277);
...
try {
		Debug.PushSubsStack("tf_BeginEdit (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,269);
...
try {
		Debug.PushSubsStack("tf_EndEdit (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,273);
...
try {
		Debug.PushSubsStack("tf_EnterPressed (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,320);
...
try {
		Debug.PushSubsStack("tf_FocusChanged (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,234);
...
try {
		Debug.PushSubsStack("tf_TextChanged (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,287);
...
try {
		Debug.PushSubsStack("Update (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,245);
...
try {
		Debug.PushSubsStack("UpdateLabel (b4xfloattextfield) ","b4xfloattextfield",10,__ref.getField(false, "ba"),__ref,210);
