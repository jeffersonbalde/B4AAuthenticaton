...
try {
		Debug.PushSubsStack("Base_Resize (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,83);
...
try {
		Debug.PushSubsStack("CreateLabel (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,247);
...
try {
		Debug.PushSubsStack("Decrement (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("getSelectedValue (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("GetValueImpl (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,130);
...
try {
		Debug.PushSubsStack("Increment (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,162);
...
try {
		Debug.PushSubsStack("Initialize (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,257);
...
try {
		Debug.PushSubsStack("pnlArrow_Touch (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,195);
...
try {
		Debug.PushSubsStack("SetIndex (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,142);
...
try {
		Debug.PushSubsStack("SetNumericRange (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,108);
...
try {
		Debug.PushSubsStack("setSelectedValue (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("SetStringItems (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("StartDownLoop (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,234);
...
try {
		Debug.PushSubsStack("Touch (b4xplusminus) ","b4xplusminus",16,__ref.getField(false, "ba"),__ref,199);
