...
try {
		Debug.PushSubsStack("Base_Resize (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("BusyLoop (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("DesignerCreateView (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("getProgressColor (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("getValue (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,157);
...
try {
		Debug.PushSubsStack("getVisible (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,153);
...
try {
		Debug.PushSubsStack("Initialize (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("setProgressColor (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("setValue (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,161);
...
try {
		Debug.PushSubsStack("SetValueNoAnimation (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,165);
...
try {
		Debug.PushSubsStack("setVisible (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,145);
...
try {
		Debug.PushSubsStack("UpdateGraphics (anotherprogressbar) ","anotherprogressbar",4,__ref.getField(false, "ba"),__ref,112);
